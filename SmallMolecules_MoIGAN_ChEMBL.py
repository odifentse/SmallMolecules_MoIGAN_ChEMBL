...
# Download ChEMBL dataset from MolNet
# tasks, datasets, transformers = dc.molnet.load_chembl25()
# df = pd.DataFrame(data={'smiles': datasets[0].ids})
# df   #total of 19096 molecules

tasks, datasets, transformers = dc.molnet.load_chembl(reload=False)
df = pd.DataFrame(data={'smiles': datasets[0].ids})
df

# STEP 3: SPECIFY THE MAX NUMBER OF ATOMS TO ENCODE FOR FEATURIZER AND MOIGAN NETWORK
